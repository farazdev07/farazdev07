...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=26&duration=3000&pause=800&color=00D8FF&center=true&vCenter=true&width=650&lines=Senior+React+Native+%26+Full+Stack+Developer;5%2B+years+%C2%B7+16%2B+production+apps+shipped;Fintech+%C2%B7+Health+%C2%B7+Real+Estate+%C2%B7+Logistics;Now+building+in+AI+Automation+Engineering" alt="Typing SVG" />
...
const faraz = {
  ...
  experience: "5+ years",
  shipped:    "16+ production apps",
  domains:    ["Fintech", "Healthcare", "Real Estate", "Logistics"],
  depth:      ["RN New Architecture", "TurboModules", "Fabric", "JSI", "WebRTC"],
  learning:   ["AI Agents", "MCP", "Agentic Automation"],
  scale:      "Telehealth WebRTC app · 1M+ downloads",
};
```
...
- Native bridging & custom native modules
...
- Prompt systems for production features
...
- Auth, RBAC, realtime subscriptions
...
- OTA release strategy (Revopush)
- Git workflows, code review, release management
...
<img src="https://img.shields.io/badge/Reanimated-001A72?style=for-the-badge&logo=react&logoColor=white" />
<img src="https://img.shields.io/badge/React_Navigation-6B52AE?style=for-the-badge&logo=react&logoColor=white" />
<img src="https://img.shields.io/badge/RevenueCat-F2545B?style=for-the-badge&logo=apple&logoColor=white" />
...
- 🧩 Going deeper on **native bridging** — TurboModules & Fabric components
- 🤖 Building an **AI Automation Engineer** layer on top of mobile: agents, MCP, tool-calling
- 🚀 Shipping a solo Android product end-to-end (AI + native alarm mechanics)
- 💬 Happy to talk React Native performance, WebRTC, CI/CD, or LLM integration
...
<i>Open to senior remote roles · React Native · Full Stack · AI Automation</i>
